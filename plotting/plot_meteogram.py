...
import sys
from utils import annotation, annotation_run, print_message, get_time_run_cum, get_city_coordinates, read_dataset, get_weather_icons, \
    get_colormap, processes, truncate_colormap, folder_images
import pandas as pd
import numpy as np
...
def plot(dset_city):
    ...
    _ = ax0.contourf(time, plevs, clc.T,
    ...
    _ = annotation(ax0, 'Cloud cover, $T$ and winds @(%3.1fN, %3.1fE, %d m)' % (dset_city.lat, dset_city.lon, dset_city.HSURF),
                        loc='upper left')
