...
def main():
    ...
    clima = xr.open_dataset('/home/ekman/guido/climatologies/clima_1981-2010_uerra_atmo_t_2m_remap_iconeu.nc').squeeze().sel(time='2010')
    ...
    merged = xr.merge([clima.rename({'2t': 't_clima'}), dset], join='inner')
    # now compute anomaly
    merged['anomaly'] = merged['2t'] - merged['t_clima']
...
#         patheffects.withStroke(linewidth=0.1, foreground="green")])
        ...
        an_var = annotation(args['ax'], 'Daily 2m temp. anomaly (w.r.t to UERRA 1981-2010 clima)',
